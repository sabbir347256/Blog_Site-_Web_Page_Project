    ...
    const onSubmit = (data) => {
        ...
        createUser(email, pass)
            .then(res => {
                ...
                fetch(`https://takbir-server-site.vercel.app/registerUser`, {
                    method: 'POST',
                    headers: {
        ...
        <div className="hero min-h-screen bg-base-200 loginBg">
            <div className="hero-content ">
                <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    ...
                    <p className="mx-4 mb-4">All Ready have an account . please <NavLink to='/signin' className='text-blue-600 font-bold'>Login</NavLink></p>
                </div>
                {
                    success && <p>{success}</p>
                }
